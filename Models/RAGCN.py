# RAGCN: Recurrent Adaptive Graph Convolutional Networks
...
# Network
class RecurrentAdaptiveGraphConvolutionalNetworks(nn.Module):

    # Initialization
    def __init__(self, dim_X, dim_y, node_embedding_size=128, rnn=(1024,), gc=(1024,), out_fc=(256, 256),
                 adj_mode='pearson', graph_reg=0.05, self_con=0.2, scale=0.4, epsilon=0.1,
                 prob='regression'):
        super(RecurrentAdaptiveGraphConvolutionalNetworks, self).__init__()
...
# Model
class RagcnModel(NeuralNetwork):

    # Initialization
    def __init__(self, node_embedding_size=128, rnn=(1024,), gc=(1024,), out_fc=(256, 256), prob='regression', **args):
        super(RagcnModel, self).__init__()
    ...
    def fit(self, X, y):
        ...
        # Model creation
        self.model = RecurrentAdaptiveGraphConvolutionalNetworks(
            self.dim_X, self.dim_y, self.node_embedding_size, self.rnn, self.gc, self.out_fc,
